                        ...
                        child: RichText(
                          text: TextSpan(children: [
                            const TextSpan(
                                ...
                                text: 'CfJは、CfJが提供する睡眠のセルフモニタリングツールであるアプリケーション・ソフトウェア「gussuri」及び「gussuri」上で提供するサービス（以下総称して「本サービス」といいます）のユーザーの情報（以下「ユーザー情報」といいます）の取扱いについて、次のとおりgussuriプライバシーポリシー（以下「本ポリシー」といいます）を定めます。利用者は、本サービスの初回起動時に本ポリシーに同意して、本サービスを利用するものとします。利用者は、本サービスの設定画面からいつでも本ポリシーを確認することができます。本サービスの用語の定義は、特段の定めのない限り「gussuriサービス利用規約」及び個人情報の保護に関する法律（平成15年法律第57号。以下「個人情報保護法」といいます）によるものとします。\n'
